"""Coordinator-based noticeboard messages sensor for Bakalari."""
...
class BakalariNoticeboardSensor(BakalariEntity, SensorEntity):
    ...
    def __init__(self, coordinator: Any, child: Child) -> None:
        ...
        self._attr_unique_id = f"{coordinator.entry.entry_id}:{child.key}:noticeboard"
        self._attr_name = f"Nástěnka - {child.short_name}"
